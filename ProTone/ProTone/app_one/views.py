...
def team(request):
    return render(request, 'app_one/team.html')
...
def special(request):
    return HttpResponse("You are logged in, hahah wtf")
...
def register(request):
    ...
    return render(request, 'app_one/signup.html', {'user_form':user_form,
